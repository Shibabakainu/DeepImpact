...
io.on("connection", (socket) => {
  ...
  // ストーリーリストを定義（ラウンドごと）
const stories = [
  "昔々、平和な国があり、その国は緑豊かな土地と、穏やかな人々に恵まれていました。しかし魔王が現れ軍勢を率いて国を支配しまし。\n魔王は強力な魔法が使え、心臓が３つあり、国は恐怖に包まれました。人々は魔王に立ち向かう勇者が現れるのを待ち望んでいました。そんな時、小さな町に住むが立ち上がりました。"<span>"正義感の強い若い戦士",
  "正義感の強い若い戦士は魔王を倒しに行こうと決心しました。しかし３つの心臓と軍勢相手に一人で行くのはあまりにも無謀だと思いました。それに３つの心臓はそれぞれ火と水と風の剣でないと効果がないことが分かりその剣の持ち主を探しに行きました。まず火の洞窟へ持ち主に会いに行きました。火の剣の持ち主はすごく協力的で"<span>"体中に傷があり"<span>"鋭い目</b>をしていました。",
  "次に水の剣の持ち主に会いに行きました。水の剣の持ち主は協力してくれたものの<b>愛想の悪い面倒くさがりの性格</b>でした。",
  "最後に風の剣の持ち主に会いに行きました。風の剣の持ち主は警戒心が強く目力も強い背の高い力持ちでした。最後に風の剣の持ち主に会いに行きました。風の剣の持ち主は警戒心が強く目力も強い背の高い力持ちでした。",
