    ...
    <main>
        <div class="container">
            ...
            <div class="buttons">
                ...
                <?php
                if ($_SESSION['user_id'] == $host_id) {
                    echo '<button id="start-game-btn" data-room-id="<?php echo $room; ?>">物語を作る</button>';
                } else {
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', (event) => {
            ...
            socket.on('gameStarted', (data) => {
                ...
                window.location.href = 'game.php?room_id=' + encodeURIComponent(data.roomId);
            })
